        ...
        switch (path.length) {
            ...
            case 3:
                try {
                    ...
                    writeResponse("Epic id need be integer", exchange, 400);
                } catch (NotFoundException e) {
                    writeResponse("Epic not founded", exchange, 404);
                }
                break;
            case 4:
        ...
        switch (path.length) {
            ...
            case 2:
                try {
                    ...
                    writeResponse("Create epic success", exchange, 201);
                }
                break;
            // update
            case 3:
                try {
                    ...
                    writeResponse("Update epic success", exchange, 201);
                } catch (NullTaskException e) {
                    writeResponse("Internal Server Error", exchange, 500);
                }
                break;
