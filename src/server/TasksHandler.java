        ...
        switch (path.length) {
            ...
            case 3:
                try {
                    ...
                    writeResponse("Type id need integer", exchange, 400);
                } catch (NotFoundException e) {
                    writeResponse("Task not founded", exchange, 404);
                }
                break;
            default:
        ...
        switch (path.length) {
            ...
            case 2:
                try {
                    ...
                    writeResponse("Create task success", exchange, 201);
                }
                break;
            // update
            case 3:
                try {
                    ...
                    writeResponse("Update task success", exchange, 201);
                } catch (NullTaskException e) {
                    writeResponse("Internal Server Error", exchange, 500);
                }
                break;
